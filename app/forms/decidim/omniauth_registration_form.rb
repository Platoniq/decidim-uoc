...
module Decidim
  ...
  class OmniauthRegistrationForm < Form
    ...
    def uoc?
      provider == OmniAuth::Strategies::Uoc::PROVIDER_NAME
    end
    ...
    def uoc_affiliation_valid?
      ...
      errors.add(:uoc_affiliations, :invalid) unless uoc_affiliations.any? { |affiliation| OmniAuth::Strategies::Uoc::AFFILIATIONS.include? affiliation }
    end
  end
end
